...
export const WorkspacesUIWithPanels = () => {
	...
	return (
		<>
				...
				<div className="neo-input-group" style={{ marginBottom: "8px" }}>
					<label className="neo-switch" htmlFor="uncheckedCheckbox">
						<input
							...
							aria-checked={hasLeftNavigation}
				...
				<div className="neo-input-group">
					...
					<div className="neo-select" style={{ width: "30%" }}>
						...
						>
							...
							<option value="2">
								One Smaller Panel Left, One Larger Panel Right{" "}
							</option>
							<option value="3">
								One Larger Panel Left, One Smaller Panel Right{" "}
							</option>
							...
							<option value="12">
								One Panel Left, Two Panels Center, Two Panels Right
							</option>
							<option value="13">
								Two Panels Left, One Panel Center, Two Panels Right
							</option>
							<option value="14">
								Two Panels Left, Two Panels Center, One Panel Right
							</option>
			...
			>
				<div className="neo-ws-layout--header neo-panel neo-panel--bordered--bottom">
					<nav className="neo-navbar">
						...
						<div className="neo-nav">
							...
							<div className="neo-badge__navbutton">
								...
								/>
								<span className="neo-badge__icon" data-badge="99" />
							</div>
							<div className="neo-badge__navbutton">
								<button
									type="button"
				...
				{hasLeftNavigation && (
					<div className="neo-ws-layout--sidebar neo-panel--bordered--side">
						<div
							className={
								condensed
								...
								<ul className="neo-leftnav__nav">
									...
									<li className="neo-leftnav__main">
										<a
											href="https://design.avaya.com"
											target="_blank"
											className="neo-icon-address-book"
											rel="noreferrer"
										>
											Contact Center
										</a>
									...
									<li className="neo-leftnav__main">
										<a
											href="https://design.avaya.com"
											target="_blank"
											className="neo-icon-chart-gauge"
											rel="noreferrer"
										>
											Menu 4
										</a>
