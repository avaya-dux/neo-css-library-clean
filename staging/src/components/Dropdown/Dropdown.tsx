	...
	return (
		<div className="neo-dropdown neo-dropdown--active">
			...
			<div className="neo-dropdown__content" role="menu">
				...
				<a className="neo-dropdown__link" role="menuitem" href="#">
					Regular action
				</a>
				...
				<a className="neo-dropdown__link" href="/dropdown#">
					<figure className="neo-avatar neo-avatar--small" data-initials="SM" />
					Another action
				</a>
			</div>
		</div>
			...
			<div className="neo-dropdown__content" role="menu">
				...
				<div className="neo-dropdown--input">
					...
					<button
						...
						className="neo-btn-square neo-btn-square-tertiary neo-btn-square-tertiary--info neo-icon-voice"
					/>
				</div>
			</div>
		</div>
