...
Thus, the docker image version chosen should be v1.34.2-focal.
...
From Playwright (`neo-css-library/playwright`): `docker run --rm --network host -v $(pwd):/work/ -w /work/ -e BASEURL=http://host.docker.internal:3000 -it mcr.microsoft.com/playwright:v1.34.2-focal /bin/bash`
