  ...
  for (component of value.Navigation.children) {
      ...
      for (variant of component.children) {
        if (variant.name === 'State=ready') {
          ...
          navbarJSONObject.navbar['avatar-border-style'] = {
            value: variant.children[0].children[0].children[1].children[0].children[0].strokes[0].type.toLowerCase(),
          };
          // border-color
          ...
          await coreFigmaFunctions
            ...
            .then((value) => {
              var agentCardNameFontTokenName = value.nodes[
                agentCardNameFontTokenID
          ...
          await coreFigmaFunctions
            ...
            .then((value) => {
              var agentCardStatusFontTokenName = value.nodes[
                agentCardStatusFontTokenID
              ].document.name.toLowerCase();
              // font-size
    ...
    if (component.name === 'navbar/tab') {
      ...
      await coreFigmaFunctions
        ...
        .then((value) => {
          var navbarTabFontTokenName = value.nodes[
            navbarTabFontTokenID
          ].document.name.toLowerCase();
          // font-size
    ...
    if (component.name === '.navbar-container-base') {
      ...
      navbarJSONObject.navbar['bottom-border-width'] = {
        value: `${component.children[0].strokeWeight}px`,
      };
      // border style
      ...
      // border-color
      var navbarBorderColorTokenID = component.children[0].styles.stroke;
